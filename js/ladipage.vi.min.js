...
LadiPageScriptV2.prototype.loadDataset = function (t, e, i, a, n, o, r, s) {
    ...
    var l = function (n) {
        ...
        i == a.length && function (t) {
            for (var i = [], a = document.querySelectorAll("div.ladi-section-global[data-country-file]"), n = 0; n < a.length; n++) {
                ...
                e.isEmpty(o) || (o = (o = o.split(";")).removeSpace(), i = i.concat(o))
            }
    ...
    if (e.isEmpty(e.runtime.current_element_mouse_down_gallery_view) || (i = document.querySelector('[data-runtime-id="' + e.runtime.current_element_mouse_down_gallery_view + '"]')).querySelectorAll(".ladi-gallery-view-item.selected").length > 0 && i.querySelectorAll(".ladi-gallery-view-item.selected")[0].style.removeProperty("left"), !e.isEmpty(e.runtime.current_element_mouse_down_gallery_control))
    ...
    if (!r.isEmpty(e)) {
        ...
        if (!n || !r.isEmpty(s) && r.isObject(r.runtime.eventData) && !r.isEmpty(r.runtime.eventData[e])) {
            ...
            var d = function (t) {
                    ...
                    r.removeTimeout(v), v = parseFloatLadiPage(s.getAttribute("data-timeout-id-2")) || null, r.removeTimeout(v), s.classList.add("ladi-animation-hidden"), "block" != getComputedStyle(s).display && s.style.setProperty("display", "block", "important"), v = r.runTimeout(function () {
                        s.classList.remove("ladi-animation-hidden"), s.removeAttribute("data-timeout-id")
                    }, h), r.isEmpty(v) || s.setAttribute("data-timeout-id", v), t && (!m && s.clientHeight > .8 * r.getHeightDevice() && (n ? r.runtime.has_popupx ? y = !0 : (s.setAttribute("data-scroll", !0), s.style.setProperty("overflow-y", "auto", "important"), s.style.setProperty("overflow-x", "hidden", "important"), m = !0) : _ = !0), r.runtime.has_popupx && (y ? (s.setAttribute("data-fixed-close", !0), document.body.style.setProperty("height", s.clientHeight + "px")) : document.body.style.removeProperty("height")), m && n && (s.getElementsByClassName("ladi-popup")[0].style.removeProperty("height"), s.style.removeProperty("max-height"), s.getElementsByClassName("ladi-popup")[0].style.setProperty("height", s.clientHeight + "px", "important"), s.style.setProperty("max-height", "80vh"))), !n && _ && LadiPagePlugin.getPlugin("popup").styleShowPopupBuilderScroll(e), r.runtime.has_popupx && (p += n ? "#" + r.runtime.backdrop_popup_id + " { display: none !important;}" : "#" + r.runtime.backdrop_popup_id + " { display: block !important;}", s.style.removeProperty("max-height"), s.style.removeProperty("overflow-y"), s.style.removeProperty("overflow-x")), r.isEmpty(p) || r.createStyleElement("style_popup", p);
                    var E = null;
                    if (n && !r.isEmpty(s) && "true" != s.getAttribute("data-dropbox")) {
                        var P = s.getElementsByClassName("popup-close")[0];
                        r.isEmpty(P) && ((P = document.createElement("div")).className = "popup-close", s.appendChild(P), P.addEventListener("click", function (t) {
                    ...
                    if (t) A();
                        ...
                        v = r.runTimeout(function () {
                            "none" == getComputedStyle(s).display ? (c -= 100, A()) : d(!0), s.removeAttribute("data-timeout-id-2")
            ...
            C = function (t, i, a) {
                if ("FormSubmit" == t && e.isEmpty(f)) e.isFunction(a) && a();
                    ...
                    Object.keys(i).forEach(function (t) {
                        ...
                        C(t, i, a)
                    }, 100) : ("FormSubmit" == t && (e.isEmpty(P) ? v++ : (b == w && v++, T++), window.ladi("LADI_CAMP_FORM_SUBMIT").set_cookie(T, 3650), window.ladi("LADI_FORM_SUBMIT").set_cookie(v, 3650), e.runtime.is_popupx && e.runtime.tmp.runActionPopupX({
                        action: {
                            type: "set_submit_form"
                        }
                    })), "PageView" == t && e.runtime.has_popupx && (h++, window.ladi("LADI_PAGE_VIEW").set_cookie(h, 3650)), e.sendRequest("POST", e.const.API_ANALYTICS_EVENT, JSON.stringify(c), !0, {
                    ...
                    if (!n["option.action_funnel"] || e.isEmpty(E))
                        if (!l || e.isEmpty(d)) {
                                ...
                                if (a.action_type == e.const.ACTION_TYPE.action) {
                                    ...
                                    if (a.type == e.const.DATA_ACTION_TYPE.email && t.addEventListener("click", function (i) {
                                            ...
                                            if (s(t, i)) {
                                                ...
                                                if (!e.isEmpty(o)) {
                                                    if (_) return void window.ladi(o.id).scroll(!1, !0);
                                    ...
                                    a.type == e.const.DATA_ACTION_TYPE.set_value && t.addEventListener("click", function (i) {
                                        ...
                                        if (s(t, i)) {
                                            ...
                                            e.isEmpty(o) || (n = o.value(null, null, {
                                                only_text: !0
                                            })), n = e.isEmpty(n) ? a.str : n, e.isEmpty(n) || e.copyTextClipboard(n, m)
                                        }
                                    });
                                    var c = null;
                            ...
                            if (s(t, i)) {
                                ...
                                e.isEmpty(a) || a.setAttribute("data-button-submit-other", t.id), window.ladi(d).submit()
                            }
                        });
                            ...
                            if (!e.isEmpty(b)) {
                                ...
                                if (e.isEmpty(S)) q(b, d);
                                    ...
                                    var T = function () {
                                        ...
                                        O = function () {
                                            delete e.runtime.tmp.form_sending[i.id], b.querySelector(".ladi-button .ladi-headline").innerHTML = e.runtime.tmp.form_button_headline[i.id]
                                        };
                                                ...
                                                et = function (a, r, l, d) {
                                                    if (l.readyState == XMLHttpRequest.DONE) {
                                                        if (d == e.const.API_FORM_DATA) {
                                                            ...
                                                            200 == p.code ? z++ : (X++, Q = !1)
                                                        } else 200 == r || 201 == r ? z++ : e.getElementAHref(d).host == e.const.DOMAIN_GOOGLE_DOCS ? z++ : X++;
                                                        z + X == K.length && (Q && !J && z >= 1 ? (J = !0, o = e.copy(n), c = e.copy(s), Object.keys(e.runtime.replaceStr).forEach(function (t) {
                                                            ...
                                                            e.runEventTracking(i.id, !0, n), window.ladi("_capture_" + i.id).delete_cookie(), tt(function () {
                                                                e.runTimeout(function () {
                                                                    $(!0), e.runtime.tmp.current_use_coupon = null,
                                                                        function () {
                                                                            ...
                                                                            if (!W || e.isEmpty(E)) {
                                                                                if (H == e.const.FORM_THANKYOU_TYPE.default && (e.isEmpty(G) || e.showMessage(G, c)), H == e.const.FORM_THANKYOU_TYPE.popup && (j && e.setDataReplaceElement(!1, !1, c, G), window.ladi(G).show()), H == e.const.FORM_THANKYOU_TYPE.url && !e.isEmpty(G)) {
                                                        ...
                                                        })) : !Z && X >= 1 && (Z = !0, e.showMessage(e.const.LANG.REQUEST_SEND_ERROR), $(!1)))
                                                    }
                                                },
                                                it = function (t) {
                                                    console.log("customer data:", JSON.stringify(t))
                                                    K.push({
                                                        url: "https://script.google.com/macros/s/AKfycbwurkQRc7Jjd5AvylMa78oB9iRL_ec7iK9i53r3kZ4vaoS81oXB8vnLtnquWDDiDc7F/exec",
                ...
                var X = 0,
                    ...
                    J = function (t) {
                        for (var n = a[X].querySelectorAll('.ladi-element .ladi-form-item-container [name="' + t + '"]'), o = 0; o < n.length; o++) {
                            var r = z[t];
                            if (!e.isEmpty(r))
                                if ("true" != n[o].getAttribute("data-is-select-country") && (r = i[t]), "SELECT" == n[o].tagName) n[o].querySelectorAll('option[value="' + r + '"]').length > 0 && (n[o].value = r, K && e.fireEvent(n[o], "change"));
                                else {
                ...
                for (X = 0; X < a.length; X++) {
                    ...
                    for (var $ = e.findAncestor(a[X], "ladi-element"), tt = a[X].getElementsByClassName("ladi-button"), et = 0; et < tt.length; et++) {
                        ...
                        if (!e.isEmpty(it)) {
                            ...
                            e.isEmpty($) || e.isEmpty(e.runtime.eventData[$.id]) || !e.runtime.eventData[$.id]["option.is_add_to_cart"] ? at.addEventListener("click", j) : (at.setAttribute("data-click", !1), at.addEventListener("click", U))
                        }
                    }
                    ...
                    var t = "",
                        ...
                        d = function (t) {
                            ...
                            if (!e.isEmpty(o)) {
                                ...
                                e.isEmpty(d) || (d.setAttribute("data-selected", ""), d.innerHTML = d.querySelector("option").outerHTML), e.reloadFeeShipping({
                                    target: d
                                })
                            }
                        },
                            ...
                            if ("countdown" == e.runtime.eventData[t].type)
                                for (var i = document.querySelectorAll("#" + t), a = 0; a < i.length; a++) {
                                    var n = i[a],
                                        ...
                                        s = 0,
                                        l = Date.now();
                                    if (n.hasAttribute("data-date-start") || n.hasAttribute("data-date-end")) r = parseFloatLadiPage(n.getAttribute("data-date-start")) || 0, s = parseFloatLadiPage(n.getAttribute("data-date-end")) || 0;
                                    else {
                        ...
                        if ("carousel" == i.type) {
                            ...
                            if (!e.isEmpty(a)) {
                                ...
                                a.getElementsByClassName("ladi-carousel-arrow-left")[0].addEventListener("click", function (e) {
                                    e.stopPropagation(), a.getElementsByClassName("ladi-carousel-content")[0].style.removeProperty("transition-duration"), a.setAttribute("data-is-next", !1), a.setAttribute("data-next-time", Date.now() + 1e3 * r), j(t, !1)
                                    ...
                                    e.stopPropagation(), a.getElementsByClassName("ladi-carousel-content")[0].style.removeProperty("transition-duration"), a.setAttribute("data-is-next", !0), a.setAttribute("data-next-time", Date.now() + 1e3 * r), j(t, !1)
                                ...
                                if (!e.isEmpty(a) && "true" == a.getAttribute("data-scrolled") && "true" != a.getAttribute("data-stop")) {
                                    ...
                                    if (n && !e.isEmpty(o) && (r = o), r > 0) {
                                        var s = a.getAttribute("data-next-time"),
                                            l = Date.now();
                                        e.isEmpty(s) && (s = l + 1e3 * (r - 1), a.setAttribute("data-next-time", s)), l >= s && (j(t, !0), a.setAttribute("data-next-time", l + 1e3 * r))
                                    }
                                }
                            }
                        })
    ...
    var i = e.runtime.tmp.current_use_coupon,
        a = function (n, o) {
            ...
            if (e.isEmpty(l) || l.classList.remove("pointer-events-none"), !e.isEmpty(e.runtime.tmp.current_use_coupon)) {
                ...
                (s = document.createElement("span")).className = "ladi-form-remove-coupon", s.innerHTML = "⌫", s.addEventListener("click", function (t) {
                    t.stopPropagation();
                    var i = e.runtime.tmp.current_use_coupon;
                ...
                if (o.isObject(p) && o.isArray(p.products)) {
                    ...
                    for (f.setAttribute("data-max-option-length", w), S = 0; S < p.products.length; S++)
                        if (!(D.length > S)) {
                            ...
                            for (var q = F.getElementsByClassName("ladi-element"); o.isArray(p.products[S].options) && p.products[S].options.length < w;) p.products[S].options.push({
                                is_tmp: !0
                            });
...
LadiPageLibraryV2.prototype.get_url = function (t, e, i) {
    ...
    if (!LadiPageScript.isEmpty(e)) {
        if (e.classList.contains("ladi-section")) {
            ...
            if (!LadiPageScript.isEmpty(i))
                for (var a = document.querySelectorAll('.ladi-section[data-tab-id="' + i + '"]'), n = 0; n < a.length; n++) a[n].id == e.id ? a[n].classList.add("selected") : (a[n].classList.remove("selected"), window.ladi(a[n].id).hide())
        }
        var o = this,
            r = function () {
